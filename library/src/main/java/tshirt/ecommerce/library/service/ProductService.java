...
public class ProductService {
    ...
    public Page<Product> searchResults(String keyword, String categoryId, String brandId, Pageable pageable) {
        List<Product> products = productRepository.searchProduct2(keyword, categoryId, brandId);
        //return products;
    ...
    public boolean checkIfExistName(String name) {
        return productRepository.findAll().stream().anyMatch(p->p.getName().equals(name));
    }
}