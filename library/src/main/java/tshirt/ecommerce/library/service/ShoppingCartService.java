...
import tshirt.ecommerce.library.repository.ShoppingCartRepository;
...
public class ShoppingCartService {
    ...
    public ShoppingCart addItemToCart(Product product, Long quantity, String size, Customer customer) {
        ...
        //minus stock quality
        product.setStockQty((int) (product.getStockQty() - quantity));
